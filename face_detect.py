...
class Face_Recognition:
    ...
    def __init__(self,root):
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # Training button 1
        std_img_btn=Image.open("Images_GUI\\facerecogn.png")
    ...
    def face_recog(self):
        ...
        faceCascade=cv2.CascadeClassifier("C:\\Users\\Hp\\AppData\\Local\\Programs\\Python\\Python311\\Lib\\site_packages\\cv2\\data\\haarcascade_frontalface_default.xml")
        
        clf = cv2.face.LBPHFaceRecognizer()
        clf.read("D:\\\Face_Recognition_Attendance_System_Project\\clf.xml")
